...
public class CalculadoraImplServiceLocator extends org.apache.axis.client.Service implements com.soap.ws.CalculadoraImplService {
    ...
    private java.lang.String CalculadoraImplPort_address = "http://localhost:1515/ws/Calculadora";
    ...
    public com.soap.ws.Calculadora getCalculadoraImplPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.soap.ws.Calculadora getCalculadoraImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.soap.ws.CalculadoraImplPortBindingStub _stub = new com.soap.ws.CalculadoraImplPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.soap.ws.Calculadora.class.isAssignableFrom(serviceEndpointInterface)) {
                com.soap.ws.CalculadoraImplPortBindingStub _stub = new com.soap.ws.CalculadoraImplPortBindingStub(new java.net.URL(CalculadoraImplPort_address), this);
                _stub.setPortName(getCalculadoraImplPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://ws.soap.com/", "CalculadoraImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://ws.soap.com/", "CalculadoraImplPort"));
        }
